...
class FirstViewController: UIViewController {
    ...
    deinit {
        ...
        NotificationCenter.default.removeObserver(self, name: Notification.Name("Received Notification"), object: nil)
    }
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(receivedNotification), name: Notification.Name("Received Notification"), object: nil)
